            ...
            <div className="flex flex-col gap-2 rounded-2xl bg-red-50/70 p-4 border border-red-200">
              ...
              <div className="flex items-center justify-between gap-3 pt-1">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1.5 rounded-xl border border-red-300 bg-white px-3 py-1.5 font-bold text-red-600 hover:bg-red-600 hover:text-white shadow-2xs transition-colors shrink-0 cursor-pointer"
                >
