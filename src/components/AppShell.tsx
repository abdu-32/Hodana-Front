    ...
    <div className="flex min-h-dvh flex-col bg-[#f3f6f4]">
      <header className="sticky top-0 z-40 bg-[#f3f6f4] backdrop-blur-md border-b border-[#d6e7e1]/80">
        <div className="mx-auto flex h-14 sm:h-16 lg:h-20 w-full max-w-7xl items-center justify-between gap-2 px-3 sm:px-6 lg:px-8">
          <Link
            href="/"
            className="flex items-center gap-2 text-text focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-focus min-w-0 shrink-0"
          >
            <span className="flex h-9 w-9 sm:h-11 sm:w-11 lg:h-14 lg:w-14 items-center justify-center rounded-xl sm:rounded-2xl bg-white border border-[#d6e7e1] shadow-xs overflow-hidden p-1 transition-transform hover:scale-105 shrink-0">
          ...
          <div className="flex shrink-0 items-center gap-1.5 sm:gap-2.5 lg:gap-4">
            <LanguageToggle />
            <div className="hidden h-5 w-px bg-black/10 md:block" aria-hidden="true" />
            <HeaderAuthControl />
          </div>
        </div>
      </header>
