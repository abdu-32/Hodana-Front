...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  // Role dashboard & app workspace routes: no public header, no footer
    ...
    <div className="flex min-h-dvh flex-col bg-[#f3f6f4]">
      <header className="sticky top-0 z-40 bg-[#f3f6f4]/90 backdrop-blur-md border-b border-[#d6e7e1]/80">
        <div className="mx-auto flex h-20 w-full max-w-7xl items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
          <Link
            href="/"
            className="flex items-center gap-3.5 text-text focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-focus"
          >
            <span className="flex h-14 w-14 sm:h-16 sm:w-16 items-center justify-center rounded-2xl bg-white border border-[#d6e7e1] shadow-xs overflow-hidden p-1 transition-transform hover:scale-105">
